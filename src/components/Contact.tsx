...
const Contact = () => {
  return (
    <div
      className="max-w-[1400px] mx-auto grid grid-cols-12 gap-4 lg:gap-12 items-center text-white/70 px-20 lg:px-16 xxl:px-0 py-24"
      id="contact"
    >
      <div className="col-span-12 lg:col-span-4 flex flex-col sm:flex-row lg:flex-col items-center lg:items-start justify-around lg:space-y-8">
        <div className="flex flex-row items-center mb-2 sm:mb-0 lg:mb-4">
          <Image src={phone} alt="phone" className="h-[70px] md:h-[110px] w-auto mr-2  xl:mr-6" />
          <a href="tel:+905348557050">
            <p className="text-xl">0534 855 7050</p>
          </a>
        </div>
        <div className="flex flex-row items-center">
          <Image src={mail} alt="mail" className="md:h-[110px] h-[70px] w-auto mr-2 xl:mr-6" />
