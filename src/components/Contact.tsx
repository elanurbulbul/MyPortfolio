        ...
        <div className='flex justify-center items-center'>
            <ul className='space-y-4'>
                <li className='flex items-center'>
                    ...
                    <p className='text-xl'>+90 534 855 7050</p>
                </li>
                <li className='flex items-center'>
        ...
        <p className='text-white/70 mb-6 lg:text-start text-center'> Send me a message and lets schedule a call!</p>
            <form className='space-y-4' action="https://getform.io/f/bejjprqa" method='POST'>
                <div className='grid md:grid-cols-2 gap-4 '>
                    <input type='text' name='first_name' className='bg-black/70 rounded-xl p-3 focus: outline-none focus:ring-2 focus:ring-orange-400' placeholder='First Name' />
